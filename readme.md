...
这是 `SHMBerBerder` 维护的 TACZ 非官方 NeoForge/Minecraft 26.2 移植仓库。

## 项目定位

- 目标版本：Minecraft 26.2 / NeoForge 26.2。
- 这个仓库用于个人移植、适配和测试，不是 TACZ 官方发布仓库。
- 历史的 `1.20.1` 分支名不再代表本仓库目标；当前移植分支是 `26.2`。
...
- 保留原有枪械玩法基础，按 26.2 运行时调整构建、API、客户端渲染和兼容层。
