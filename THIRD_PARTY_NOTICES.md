...
This project redistributes the following libraries inside its runtime artifact.
...
- Minecraft supplies LWJGL core; it is not embedded a second time by this feature.
...
The distributed artifact includes this notice and the JglTF MIT license. The
redistributed Jackson component JARs retain their upstream `META-INF/LICENSE`
